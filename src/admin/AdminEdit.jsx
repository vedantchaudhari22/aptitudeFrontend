...
const AdminEdit = () => {
    ...
    if (!formData) return (
        <div className="h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950">
            <div className="animate-pulse font-black text-blue-600 tracking-tighter text-2xl uppercase">
    ...
    const inputClasses = "w-full p-3 bg-slate-50 dark:bg-slate-950 rounded-xl border border-slate-100 dark:border-slate-800 text-slate-900 dark:text-white font-bold text-sm outline-none focus:border-blue-500 placeholder-slate-500";
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
                    <div>
                        ...
                        <h1 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight">
                            Edit <span className="text-blue-600">Question</span>
                        </h1>
                    </div>
                    <button 
                        form="edit-form"
                ...
                <form id="edit-form" onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-white dark:bg-slate-900 p-6 md:p-8 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 shadow-sm">
                            ...
                            <textarea 
                                ...
                                className="w-full p-5 rounded-2xl border-2 border-slate-100 dark:border-slate-800 dark:bg-slate-950 text-slate-900 dark:text-white focus:border-blue-500 outline-none transition-all text-lg font-medium" 
                                rows={3}
                                ...
                                {formData.options.map((opt, i) => (
                                    <div key={i} className="relative">
                                        ...
                                        <input 
                                            type="text" 
                                            value={opt} 
                                            className="w-full pl-10 pr-4 py-4 rounded-2xl border-2 border-slate-100 dark:border-slate-800 dark:bg-slate-950 text-slate-900 dark:text-white focus:border-blue-500 outline-none transition-all font-bold" 
                        ...
                        <div className="bg-white dark:bg-slate-900 p-6 md:p-8 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 shadow-sm">
                            ...
                            <textarea 
                                ...
                                className="w-full p-5 rounded-2xl border-2 border-slate-100 dark:border-slate-800 dark:bg-slate-950 text-slate-900 dark:text-white focus:border-blue-500 outline-none transition-all text-sm leading-relaxed" 
                                rows={5}
                    ...
                    <div className="space-y-6">
                            ...
                            <div className="space-y-5">
                                ...
                                <div>
                                    ...
                                    <input 
                                        ...
                                        className="w-full p-3 bg-emerald-50 dark:bg-emerald-900/10 rounded-xl border border-emerald-100 dark:border-emerald-800 text-slate-900 dark:text-emerald-400 font-black text-sm outline-none focus:border-emerald-500"
                        ...
                        <div className="bg-blue-600 dark:bg-blue-900/30 p-6 rounded-[2.5rem] border border-blue-500/20 shadow-lg shadow-blue-500/10">
                            ...
                            {formData.imageUrl && (
                                <div className="mb-4 rounded-xl overflow-hidden border border-white/10 aspect-video bg-slate-950 flex items-center justify-center">
                                    <img 
